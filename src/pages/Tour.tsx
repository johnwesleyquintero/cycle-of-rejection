      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Experience the raw energy and atmosphere of our live performances. Join us on our journey across the country.
          </p>
        </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <div className="flex-shrink-0 text-center">
                      <div className="bg-brand-red rounded-2xl p-4 w-20 h-20 flex flex-col items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="text-white text-xs font-semibold">{dateInfo.month}</div>
                      </div>
                      <div className="text-xs text-gray-400 mt-2">{dateInfo.weekday}</div>
                    </div>
        ...
        <div className="bg-gradient-metal rounded-2xl p-8">
          <h2 className="text-3xl font-bold text-white mb-6">Tour Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>Full live performance of songs from both "The Hollow Path" and "Rebirth"</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-brand-red rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  <span>Immersive visual experience with custom lighting and stage design</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-brand-red rounded-full mt-2 mr-3 flex-shrink-0"></div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">Contact & Booking</h3>
              <div className="space-y-4 text-gray-300">
                <p>
                  For booking inquiries and private events, reach out to our management team.
                </p>
                <div className="space-y-2">
                  <p><strong className="text-white">Management:</strong> booking@cycleofrejection.com</p>
                  <p><strong className="text-white">Press:</strong> press@cycleofrejection.com</p>
                  <p><strong className="text-white">General:</strong> hello@cycleofrejection.com</p>
                </div>
              </div>
            </div>
          </div>
